...
Keeping plots in their own module means:
  • bb84_runner.py has zero matplotlib imports
  • Phase 3/4/5 can add new plot functions here without touching other files
  • Notebook cells can import only what they need
"""
